...
> Figma는 윈도우, 맥, 리눅스, 크롬북, 심지어 iOS나 안드로이드 태블릿에서도 편집이 가능합니다.       
~~물론 권장하는 방법은 아닙니다~~
...
Figma는, 아시겠지만, UI/UX를 제작하는 툴입니다. 하지만 PowerPoint 역시 화면정의서가 아니라 프레젠테이션을 제작하는 툴이죠. 그런 관점에서 보면, Figma는, **좀 더 자세하게 화면정의서를 그릴 수 있는 툴**이 되겠습니다. 
