...
> 사실, 반쯤은 장난삼아, 소스코드 내에 주석을 몇 글자 더 적었습니다. 
<?-- // 도망쳐 -->
...
- [구글 애널리틱스(유/무료)](https://analytics.google.com)
- [네이버 애널리틱스(무료)](https://analytics.naver.com)
- [뷰저블(유료, 클릭/스크롤 위치 등 제공)](https://www.beusable.net/)
- [Adobe 애널리틱스](https://www.adobe.com/kr/analytics/adobe-analytics.html)

> 특히 이 중 뷰저블은 사용성 테스트 과정에서 매우 의미있는 데이터를 제공할 수 있으므로, 무료 사용으로라도 한 번쯤 이용해보심을 추천합니다. (광고 아니에요 정말 좋아요)
