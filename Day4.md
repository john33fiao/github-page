...
사실, 이 때까지만 해도 포기할 수 있었습니다. 그런데 당시에는 연말이라 큰 프로젝트가 없다시피했고, 당시 저는 애사심이 꽤 많이 남아있던 상태였습니다. ~~신성한 회사홈페이지에 어딜 감히 스팸이야!~~ 댓글 일괄 삭제를 위해, DB 접속을 시도합니다. 

[DB에 대한 설명 간단히 남겨둘 것. SQL 등 위키피디아 주소.]

[SQL](https://mets.co.kr)
